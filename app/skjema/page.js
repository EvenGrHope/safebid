...
function ElsparkesykkelForsikring({ data, onNext, onBack }) {
  ...
  // Lokal visningsverdi for forsikringssum (for å unngå at input låser seg)
  const [displayValue, setDisplayValue] = useState(
    data.forsikringssum
      ? Number(data.forsikringssum).toLocaleString("no-NO") + " kr"
      : ""
  ...
  // --- Funksjoner for riktig håndtering av tallfelt ---
  const handleForsikringssumChange = (e) => {
    const digitsOnly = e.target.value.replace(/[^\d]/g, "");
    setLocalData({ ...localData, forsikringssum: digitsOnly });
    setDisplayValue(digitsOnly);
  ...
  // --- Validering ---
  const handleNext = () => {
    if (!localData.dekning) {
      alert("Vennligst velg ønsket dekning før du går videre.");
      return;
    }
    onNext(localData);
  };
    ...
    <div className="space-y-8">
      ...
      <div className="bg-gray-50 p-6 rounded-2xl border border-gray-100 space-y-6">
        ...
        <div>
          ...
          <input
            type="text"
            placeholder="F.eks. Xiaomi, Ninebot, E-Way"
            className="w-full border rounded-lg px-4 py-3 placeholder-gray-400 focus:ring-2 focus:ring-blue-600"
            value={localData.merke}
            onChange={(e) =>
              setLocalData({ ...localData, merke: e.target.value })
        ...
        <div>
          ...
          <input
            type="text"
            placeholder="F.eks. Pro 2, Z10, E600"
            className="w-full border rounded-lg px-4 py-3 placeholder-gray-400 focus:ring-2 focus:ring-blue-600"
            value={localData.modell}
            onChange={(e) =>
              setLocalData({ ...localData, modell: e.target.value })
        ...
        <div>
          <label className="block mb-2 font-medium text-gray-800">
            Understellnummer (valgfritt)
          </label>
          <input
            type="text"
            placeholder="F.eks. SN123456789"
            className="w-full border rounded-lg px-4 py-3 placeholder-gray-400 focus:ring-2 focus:ring-blue-600"
            value={localData.understellnummer}
            onChange={(e) =>
              setLocalData({ ...localData, understellnummer: e.target.value })
            }
          />
        </div>

        {/* Forsikringssum – med riktig kr-format */}
        <div>
          <label className="block mb-2 font-medium text-gray-800">
            Forsikringssum (valgfritt)
          </label>
          <input
            type="text"
            inputMode="numeric"
            placeholder="F.eks. 15 000 kr"
            className="w-full border rounded-lg px-4 py-3 placeholder-gray-400 focus:ring-2 focus:ring-blue-600"
            value={displayValue}
            onChange={handleForsikringssumChange}
            onFocus={handleForsikringssumFocus}
...
function TilhengerForsikring({ data, onNext, onBack }) {
  ...
  // Egen visningsverdi for kr-feltet
  const [displayValue, setDisplayValue] = useState(
    data.forsikringssum
      ? Number(data.forsikringssum).toLocaleString("no-NO") + " kr"
      : ""
  ...
  // --- Funksjoner for korrekt tallhåndtering ---
  const handleForsikringssumChange = (e) => {
    const digitsOnly = e.target.value.replace(/[^\d]/g, "");
    setLocalData({ ...localData, forsikringssum: digitsOnly });
    setDisplayValue(digitsOnly);
    ...
    <div className="space-y-8">
      ...
      <div className="bg-gray-50 p-6 rounded-2xl border border-gray-100 space-y-6">
        ...
        <div>
          ...
          <input
            type="text"
            placeholder="F.eks. 6251, 5310, Proline 750"
            className="w-full border rounded-lg px-4 py-3 placeholder-gray-400 focus:ring-2 focus:ring-blue-600"
            value={localData.modell}
            onChange={(e) =>
              setLocalData({ ...localData, modell: e.target.value })
        ...
        {/* Forsikringssum – med korrekt format og backspace-støtte */}
        <div>
          <label className="block mb-2 font-medium text-gray-800">
            Forsikringssum <span className="text-red-500">*</span>
          </label>
    ...
    <div className="space-y-8">
      ...
      <div className="bg-gray-50 p-6 rounded-2xl border border-gray-100 space-y-6">
        ...
        <div>
          ...
          <input
            type="text"
            placeholder="F.eks. John Deere, Massey Ferguson"
            className="w-full border rounded-lg px-4 py-3 placeholder-gray-400 focus:ring-2 focus:ring-blue-600"
            value={localData.merke}
            onChange={(e) =>
              setLocalData({ ...localData, merke: e.target.value })
...
function VeteranForsikring({ data, onNext, onBack }) {
  ...
  // Egen state for visning av formaterte tall (unngår input-låsing)
  const [displayValue, setDisplayValue] = useState(
    data.forsikringssum
      ? Number(data.forsikringssum).toLocaleString("no-NO") + " kr"
      : ""
    ...
    <div className="space-y-8">
      ...
      <div className="bg-gray-50 p-6 rounded-2xl border border-gray-100 space-y-6">
        ...
        <div>
          ...
          <input
            type="text"
            placeholder="F.eks. Volvo, Ford, Mercedes-Benz"
            className="w-full border rounded-lg px-4 py-3 placeholder-gray-400 focus:ring-2 focus:ring-blue-600"
            value={localData.merke}
            onChange={(e) =>
              setLocalData({ ...localData, merke: e.target.value })
        ...
        <div>
          ...
          <input
            type="text"
            placeholder="F.eks. Amazon, Mustang, 280SL"
            className="w-full border rounded-lg px-4 py-3 placeholder-gray-400 focus:ring-2 focus:ring-blue-600"
            value={localData.modell}
            onChange={(e) =>
              setLocalData({ ...localData, modell: e.target.value })
        ...
        {/* Forsikringssum – med riktig format og backspace-støtte */}
        <div>
          <label className="block mb-2 font-medium text-gray-800">
            Forsikringssum <span className="text-red-500">*</span>
          </label>
  ...
  return (
    <div className="space-y-8">
      ...
      <div className="bg-gray-50 p-6 rounded-2xl border border-gray-100 space-y-6 text-gray-800">
        ...
        {data.elsparkesykkel.length > 0 && (
          <div>
            <h3 className="text-lg font-semibold text-blue-700 mb-2">
              🛴 Elsparkesykkelforsikring
            </h3>

            {data.elsparkesykkel.map((e, idx) => (
              <div key={idx} className="p-3 bg-white rounded-xl border mb-2 space-y-1">
                {e.merke && <p>Merke: {e.merke}</p>}
                {e.modell && <p>Modell: {e.modell}</p>}
                {e.arsmodell && <p>Årsmodell: {e.arsmodell}</p>}
                {e.understellnummer && (
                  <p>Understellnummer: {e.understellnummer}</p>
                )}
                {e.forsikringssum && (
                  <p>
                    Forsikringssum:{" "}
                    {Number(e.forsikringssum).toLocaleString("no-NO")} kr
                  </p>
                )}
                {e.dekning && (
                  <p>
                    Dekning:{" "}
                    {e.dekning === "brann-tyveri"
                      ? "Brann og tyveri"
                      : e.dekning.charAt(0).toUpperCase() + e.dekning.slice(1)}
                  </p>
                )}
              </div>
            ))}
        ...
        {data.traktor.length > 0 && (
          <div>
            <h3 className="text-lg font-semibold text-blue-700 mb-2">
              🚜 Traktor og arbeidsmaskin
            </h3>

            {data.traktor.map((t, idx) => (
              <div
                key={idx}
        ...
        {data.veteran.length > 0 && (
          <div>
            <h3 className="text-lg font-semibold text-blue-700 mb-2">
              🚘 Veterankjøretøy
            </h3>

            {data.veteran.map((v, idx) => (
              <div
                key={idx}
                className="p-3 bg-white rounded-xl border mb-2 space-y-1"
              >
                {v.regnr && <p>Registreringsnummer: {v.regnr}</p>}
                {v.arsmodell && <p>Årsmodell: {v.arsmodell}</p>}
                {v.merke && <p>Merke: {v.merke}</p>}
                {v.modell && <p>Modell: {v.modell}</p>}

                {v.forsikringssum && (
                  <p>
                    Forsikringssum:{" "}
                    {Number(v.forsikringssum).toLocaleString("no-NO")} kr
                  </p>
                )}
                ...
                {v.dekning && (
                  <p>
                    Dekning:{" "}
                    {v.dekning === "brann-tyveri"
                      ? "Brann og tyveri"
                      : v.dekning.charAt(0).toUpperCase() + v.dekning.slice(1)}
                  </p>
                )}
              </div>
            ))}
